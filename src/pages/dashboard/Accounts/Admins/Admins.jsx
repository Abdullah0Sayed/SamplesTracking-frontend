...
const Admins = () => {
  ...
  const COLUMNS = [
    ...
    },
    {
      ...
      Cell: ({ value }) => (
        <span
          className={`text-sm px-6 py-1 rounded-full ${value === 1 ? "bg-green-200 text-green-800" : "bg-red-200 text-red-800"}`}
        >
          {value === 1 ? "نشط" : "غير نشط"}
        </span>
      ),

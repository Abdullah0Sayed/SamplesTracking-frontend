...
const SampleProfile = () => {
    ...
    const navLinks = [
        ...
        },
        {
            ...
            element: <SampleTestSteps SampleTests={sample?.sample_tests} />

        },
        {
            title: t('samplesManagement.sampleProfile.logs'),
            element: <SampleLogs sampleLogs={sample?.sample_logs} />
    ...
    return (
        <ProfileLayout pageTitle={t('samplesManagement.editSampleData')} navLinks={navLinks} />
    )
}

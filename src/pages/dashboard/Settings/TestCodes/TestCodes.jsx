...
const TestCodes = () => {
  ...
  const COLUMNS = [
    { header: "#", accessor: "id" },
    {
      header: t("testCodesManagement.test_codes_table.code"),
      accessor: "code",
    },
    {
      header: t("testCodesManagement.test_codes_table.name"),
      accessor: "name",
    },
    {
          ...
          <DataTable
            ...
            renderRowActions={(row) => {
              const canAnyPermission = hasAnyPermission(
                user?.permissions,
                ["test_codes.edit", "test_codes.delete"],
              ...
              return (
                canAnyPermission && (
                  <div className={`flex flex-row gap-2 items-center`}>
                    ...
                    <CheckUserPermission
                      allowedPermission={"test_codes.delete"}
                    >
                      <button
                        className={`w-8 h-8 text-xl rounded-lg bg-grey-2 text-grey-1 flex items-center justify-center hover:bg-grey-5 transition`}
                        onClick={() => {

...
const SampleLogs = ({ sampleLogs = [] }) => {
  ...
  const COLUMNS = [
    { header: "#", accessor: "id" },
    {
      header: t("samplesManagement.sample_logs_table.from_status"),
      accessor: "from_process_status",
    },
    {
      header: t("samplesManagement.sample_logs_table.to_status"),
      accessor: "to_process_status",
    },
    {
      header: t("samplesManagement.sample_logs_table.type"),
      accessor: "event_type",
    },
    { header: t("samplesManagement.sample_logs_table.note"), accessor: "note" },
    // {
    //   header: t("samplesManagement.sample_logs_table.created_by"),
